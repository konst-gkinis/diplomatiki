...
def s_demo3():
    ...
    half = Inches(5.95)
    gap = Inches(0.33)
    add_placeholder(s, bx, by + Inches(0.1), half, Inches(4.7),
        "Energy Bank: ισοζύγιο",
        "Καταθέσεις/αναλήψεις βιώσιμου καυσίμου & υπόλοιπα λογαριασμών "
        "(mass balance), ως event-sourced ledger.")
    add_placeholder(s, bx + half + gap, by + Inches(0.1), half, Inches(4.7),
        "Bunker Optimization: πλάνο",
        "Αποτέλεσμα του solver: το βέλτιστο πλάνο ανεφοδιασμού ανά λιμάνι και "
        "δρομολόγιο (BOPS / BoW).")
    footer(s)
